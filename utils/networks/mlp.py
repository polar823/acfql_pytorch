"""MLP network architectures for flow matching.

Contains two MLP implementations:
- VanillaMLP: Simplified version without LayerNorm or fancy time embeddings
- MLP: Advanced version with LayerNorm, residual blocks, and uniform frequency time embeddings (default)

Reference: /home/xukainan/much-ado-about-noising/mip/networks/mlp.py
"""
...
class MLP(BaseNetwork):
    """Advanced MLP with LayerNorm, residual blocks, and uniform frequency time embeddings.

    This is the default MLP implementation with better performance than VanillaMLP.
    """
    def __init__(
        self,
        act_dim: int,
    ...
    def forward(
        ...
        # Input projection with LayerNorm and GELU
